    ...
    <div class="container-login100" style="background-image: url('../static/images/bg-01.jpg');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <form class="login100-form validate-form" method="post" action="signin.php">
                ...
                <div class="wrap-input100 validate-input m-b-23" data-validate = "O Nome de Usuário ou Email deve ser preenchido">
                    <span class="label-input100">Nome de Usuário ou E-mail</span>
                    <input class="input100" type="text" name="username" placeholder="Digite seu Nome de Usuário ou E-mail">
                    <span class="focus-input100" data-symbol="&#xf206;"></span>
                </div>

                <div class="wrap-input100 validate-input" data-validate="A Senha deve ser preenchida">
